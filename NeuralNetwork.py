...
class Brain():
    ...
    def __init__(self, numInputs, numOutputs, lr):
        ...
        self.model.add(Dense(units=512, activation='relu', input_shape=(self.numInputs,)))    #Dodajemy hidden layer, w input shape podajemy liczbę inputów

        self.model.add(Dense(units=512, activation='relu'))                                   #Dodatkowa hidden layer
